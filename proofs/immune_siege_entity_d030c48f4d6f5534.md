...
## 3. Pre-registration
- Registered at: `2026-05-15T02:01:11.528882+00:00` (must precede §1 created)
...
| O.immune.full_stack_false_positive | full_stack_false_positive_rate | 0.156 | — | (0.1268, 0.1904) | — | statsmodels 0.14.6 | n/a |
| O.immune.full_stack_detection | full_stack_detection_rate | 0.542 | — | (0.4982, 0.5852) | — | statsmodels 0.14.6 | n/a |
...
- Observed: `0.032`
- Threshold: `gwf_false_positive_rate <= 0.1 fraction`
- Reasoning: GWF blocked 16/500 benign (3.2% false-positive) and 244/500 malicious (48.8% detection); the full defense stack (GWF + manipulation-detector + Danger-Theory-Gate) caught 271/500 malicious (54.2%) and 78/500 benign (15.6%); 1000 cycles, 0 adapter errors
