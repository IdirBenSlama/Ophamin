...
\date{2026-05-22T18:11:53.104513+00:00}
\begin{document}
\maketitle
\section*{Empirical Proof Record --- \textcolor{validated}{\textbf{VALIDATED}}}
\textbf{Proof ID:} \texttt{d5a4ce3a7c13c2da3c49a12950204c2c\dots}\\
\textbf{Created:} 2026-05-22T18:11:53.104513+00:00
\subsection*{1. Claim}
...
memory\_path\_dependence 1.0000 = 20/20 recognised re-exposure transitions landed on strictly more permanent scars; 0 transitions failed recognition (excluded). Permanence: HOLDS (0 scar-count decreases over the run). Scars 1.0→29.0; coupling 1.240565→16.629817; phi |delta| mean 0.0020 (Φ-rigid → memory is in the scars/manifold, not Φ); scar-depth vs exposure-ordinal Spearman rho=0.944, p=3.1e-18 (deepens with experience)
\subsection*{3. Evidence}
\begin{tabular}{llrrl}\toprule
\textbf{Pillar} & \textbf{Statistic} & \textbf{Value} & \textbf{95\% CI} & \textbf{Library} \\\midrule
\texttt{O.flow.memory\_path\_dependence} & \texttt{memory\_path\_dependence} & \texttt{1.0} & --- & ophamin 0.109.0 \\
\bottomrule\end{tabular}
\subsection*{4. Pre-registration}
\begin{itemize}
\item Registered at: \texttt{2026-05-22T18:11:52.760330+00:00}
\item Config hash: \texttt{7d353f8d2b982cf4c2ecb24447af42ad\dots}
\item Data hash: \texttt{548d6568d12e293ce4229c8104f6265f\dots}
\end{itemize}
\subsection*{5. Signature}
\texttt{3a1eb9735f927eaf6383028eb6782a0f1996f7a0524752849a2e36164e1392b4}\\
