...
**Proof ID:** `779d65190263daa39fcd53f54437a5f11f591fed47587d1334af6109b88f3e73`  
**Created:** 2026-05-23T23:12:01.853837+00:00
...
memory_path_dependence 1.0000 = 16/16 recognised re-exposure transitions landed on strictly more permanent scars; 0 transitions failed recognition (excluded). Permanence: HOLDS (0 scar-count decreases over the run). Scars 1.0→24.0; coupling 1.337322→11.262303; phi |delta| mean 0.0000 (Φ-rigid → memory is in the scars/manifold, not Φ); scar-depth vs exposure-ordinal Spearman rho=0.9436, p=2.4e-12 (deepens with experience)

## 3. Pre-registration

- Registered at: `2026-05-23T23:12:01.650531+00:00`
...
|---|---|---|---|---|
| `O.flow.memory_path_dependence` | `memory_path_dependence` | `1.0` | — | ophamin 0.115.2 |

## 6. Signature

`67b0dcfb80cc510b0f46f5067fb112e2625db86146434b453f517726e154bf3d`
