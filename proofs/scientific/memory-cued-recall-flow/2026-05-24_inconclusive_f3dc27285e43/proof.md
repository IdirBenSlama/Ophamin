...
**Proof ID:** `f3dc27285e437424f011904734a4ca355fb45f2928c29639f20d386cd6f5ab14`  
**Created:** 2026-05-24T03:30:05.125730+00:00
...
**Observed:** `-0.12135655881785906`

memory_lift -0.1214 = seen recall 0.2572 (n=6) − control recall 0.3785 (n=2); partial cue = first 40% of words; INCONCLUSIVE — too few valid probes per arm
...
|---|---|---|---|---|
| `O.flow.cued_recall` | `memory_lift` | `-0.12135655881785906` | — | ophamin 0.115.2 |
