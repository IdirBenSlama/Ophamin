...
- Registered at: `2026-05-17T18:08:00.899919+00:00`
...
- Dataset: `kimera-proprio-trajectory` (proprio-phase-reports, 3 records, hash `9ca122d80906…`)

## 5. Evidence

| pillar | statistic | value | 95% CI | library |
|---|---|---|---|---|
| `proprio_self_discovery` | `sub_tests_passed` | `1.0` | — | ophamin.measuring.scenarios.proprio_self_discovery 0.9.2 |
