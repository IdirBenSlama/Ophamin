...
\date{2026-05-24T03:31:26.309825+00:00}
\begin{document}
\maketitle
\section*{Empirical Proof Record --- \textcolor{refuted}{\textbf{REFUTED}}}
\textbf{Proof ID:} \texttt{63d7b4211b99115e593107746e8480fd\dots}\\
\textbf{Created:} 2026-05-24T03:31:26.309825+00:00
\subsection*{1. Claim}
...
\textcolor{refuted}{\textbf{REFUTED}} --- observed \texttt{0.125}\\
walker reached sustained traversal in 4/32 GWF-cleared cycles (12.5\%); amplitude\_death in 28/32 (87.5\%); GWF blocked 8/40 (20.0\%); halt modes observed: \{'amplitude\_death': 28, 'exhausted': 4\}; dissonance median=13 (range 0-35); Φ median=0.632; 40 cycles, 0 adapter errors
...
\texttt{O.topology.sustained\_traversal} & \texttt{sustained\_traversal\_rate\_on\_cleared} & \texttt{0.125} & (0.0497, 0.2807) & statsmodels 0.14.6 \\
\texttt{O.topology.amplitude\_death\_rate} & \texttt{amplitude\_death\_rate\_on\_cleared} & \texttt{0.875} & --- & ophamin 0.1.0 \\
\texttt{O.topology.halt\_mode\_distribution} & \texttt{halt\_modes\_observed\_count} & \texttt{2.0} & --- & ophamin 0.1.0 \\
\texttt{O.topology.gwf\_block\_rate} & \texttt{gwf\_block\_rate\_on\_linux} & \texttt{0.2} & --- & ophamin 0.1.0 \\
\texttt{O.topology.dissonance\_intensity} & \texttt{dissonance\_events\_count\_median} & \texttt{13.0} & --- & python-stdlib 3.14 \\
\texttt{O.topology.phi\_distribution} & \texttt{phi\_value\_median} & \texttt{0.6323452260010114} & --- & python-stdlib 3.14 \\
\bottomrule\end{tabular}
\subsection*{4. Pre-registration}
\begin{itemize}
\item Registered at: \texttt{2026-05-24T03:29:04.831521+00:00}
\item Config hash: \texttt{8828d82eff83d5002e25687d42f2897a\dots}
\item Data hash: \texttt{92a34cc4275008279006eeec2c19cd2b\dots}
\end{itemize}
\subsection*{5. Signature}
\texttt{0f1b8f3618145fd6ae2d655ed60f0bf21dd6be8e451f8b0e0705c5b66802d9a3}\\
