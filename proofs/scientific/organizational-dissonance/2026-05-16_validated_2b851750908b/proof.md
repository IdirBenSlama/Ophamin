...
**Outcome:** VALIDATED  
**Observed:** `0.9643652561247216`

dissonance fired in 866/898 GWF-cleared cycles (96.4%); GWF blocked 102/1000 (10.2%); manipulation_detected in 3/1000 (0.3%); dissonance_events median=22 (range 0-53); 1000 cycles, 0 adapter errors

![dissonance_active_rate_on_cleared confidence interval](assets/ci_dissonance_active_rate_on_cleared.png)

## 3. Pre-registration

- Registered at: `2026-05-16T17:33:23.939201+00:00`
...
|---|---|---|---|---|
| `O.dissonance.active_on_cleared` | `dissonance_active_rate_on_cleared` | `0.9643652561247216` | (0.9501, 0.9746) | statsmodels 0.14.6 |
| `O.dissonance.intensity_distribution` | `dissonance_events_count_median` | `22.0` | — | python-stdlib 3.14 |
| `O.dissonance.productive_score` | `productive_dissonance_score_median` | `0.5714` | — | python-stdlib 3.14 |
