...
- Dataset: `kimera-sinew-trajectory` (takwin-sinew-extended-trajectory, 500 records, hash `17afe2fa7c74…`)

## 5. Evidence

| pillar | statistic | value | 95% CI | library |
|---|---|---|---|---|
| `sinew_wider_unification` | `compatible_or_extends_count` | `10.0` | — | ophamin.measuring.scenarios.sinew_wider_unification 0.9.0 |
