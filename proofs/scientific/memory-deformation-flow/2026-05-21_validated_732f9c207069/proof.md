...
**Proof ID:** `732f9c207069c1d6a75cd1bba560341488906f0ef2c17210e04646183909068f`  
**Created:** 2026-05-21T23:23:41.453982+00:00
...
recognition floor 0.8696 over 18 re-exposure pairs (8 stimuli × 3 exposures); mean Jaccard 0.9754; 6 exposures produced no concept set; worst pair: stimulus 0 cycles 0↔8 = 0.8696
...
- Dataset: `kimera-memory-deformation-trajectory` (substrate-trajectory+reexposure, 24 records, hash `3c5602a31f04…`)

## 5. Evidence

| pillar | statistic | value | 95% CI | library |
|---|---|---|---|---|
| `O.flow.recognition_stability` | `recognition_jaccard_floor` | `0.8695652173913043` | — | ophamin 0.80.0 |
