...
**Proof ID:** `8702ccdf43db0de5c5df573a54234c87b7b8e08ac3e3306ab3e5a06ff857a34f`  
**Created:** 2026-05-21T23:02:14.116980+00:00
...
**Outcome:** VALIDATED  
**Observed:** `0.8695652173913043`

recognition floor 0.8696 over 24 re-exposure pairs (8 stimuli × 3 exposures); mean Jaccard 0.9852; 0 exposures produced no concept set; worst pair: stimulus 0 cycles 0↔8 = 0.8696

## 3. Pre-registration

- Registered at: `2026-05-21T23:02:13.750645+00:00`
...
- Dataset: `kimera-memory-deformation-trajectory` (substrate-trajectory+reexposure, 24 records, hash `f40e027c9d1b…`)

## 5. Evidence

| pillar | statistic | value | 95% CI | library |
|---|---|---|---|---|
| `O.flow.recognition_stability` | `recognition_jaccard_floor` | `0.8695652173913043` | — | ophamin 0.79.0 |

## 6. Signature

`f6a5b524f17912ce9ac8c561892556fdab2cea7d3c439acb78f662811b23593c`
