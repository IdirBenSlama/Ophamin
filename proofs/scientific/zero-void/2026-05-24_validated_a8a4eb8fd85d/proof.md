...
**Proof ID:** `a8a4eb8fd85d4582bd9ad5c090e6c077969ebe6bd1ede8266718240f87c72859`  
**Created:** 2026-05-24T03:28:40.148856+00:00
...
**Outcome:** VALIDATED  
**Observed:** `1.2415090145874483`

zero_void_proximity +1.242 (dist(zero,rest)=9.477, dist(zero,void)=8.236); void-real dist(void,rest)=8.648; plenum entropy(void)/entropy(rest)=1.124; 50 void/entropy fields

![zero_void_proximity confidence interval](assets/ci_zero_void_proximity.png)

## 3. Pre-registration

- Registered at: `2026-05-24T03:28:39.902953+00:00`
...
|---|---|---|---|---|
| `zero_as_void` | `zero_void_proximity` | `1.2415090145874483` | (0.0000, 0.0000) | numpy 2.4.4 |

## 6. Signature

`86940d5c81b4720f702e5b6da643a86cbdf82790b1a17511369544b685d4d630`
